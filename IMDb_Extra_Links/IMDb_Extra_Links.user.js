// ==UserScript==
// @name         IMDb 电影页面增强
// @description  增强 IMDb 电影页面，添加豆瓣电影链接和国内正版播放源链接, 以及字幕和torrent
// @version      0.10
// @author       Saul Lawliet
...
(function () {
  ...
  function appendBase(imdbID, doubanId, title) {
    $('.subtext').append('<br>' + title + ' | <a href="https://movie.douban.com/subject/' + doubanId + '" target="_blank">豆瓣电影</a>');
    $('.subtext').append(' | <a href="https://rarbgprx.org/torrents.php?imdb=' + imdbID + '" target="_blank">RARBG</a>');
    $('.subtext').append(' | <a href="http://subhd.com/do0/' + doubanId + '" target="_blank">Sub HD</a>');
  }
